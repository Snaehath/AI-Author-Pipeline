...
class NovelBuilder:
    ...
    def generate_complete_novel(
        ...
        from AI_Author.pipeline.inference.character_bible import CharacterBible
        from AI_Author.pipeline.inference.state_tracker import CharacterStateTracker
        from AI_Author.pipeline.inference.consistency_checker import ConsistencyChecker
        from AI_Author.pipeline.inference.critic_engine import MultiPassCriticEngine
        ...
        from AI_Author.pipeline.inference.memory_retrieval import SelectiveMemoryRetriever
