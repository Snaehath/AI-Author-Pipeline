...
| **Secondary Micro F1** | **34.8%** | > 50.0% |
| **Secondary Macro F1** | **17.8%** | > 40.0% |
| **Mean Jaccard Similarity** | **26.7%** | > 50.0% |
...
| `audit_135` | DIALOGUE_SUBTEXT | DEADPAN_REACTION (✗) | LOCAL | LOCAL | ✓ | `VALID` | ❌ |
